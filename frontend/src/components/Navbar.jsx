...
function Navbar() {
  ...
  <div className="navbar-start">
    ...
    <a className="text-2x1 font-bold curser-pointer">Book Store</a>
  </div>
  ...
  <input type="text" 
         className="grow outline-none dark:bg-slatw-500 dark:text-white"
         placeholder="Search" />
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 16 16"
...
<label className="swap swap-rotate">
  ...
  <div className="">
    <a className="bg-red text-white px-3 py-2 rounded-md hover:bg-clate-800 duration-300 cursor-pointer"
